...
const createOrder = (0, trycatch_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield order_services_1.OrderServices.createOrder(req.body, req.user);
...
const getAllOrders = (0, trycatch_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield order_services_1.OrderServices.getAllOrders(filter, options);
    (0, sendResponse_1.sendResponse)(res, {
        success: true,
...
const updateOrder = (0, trycatch_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
