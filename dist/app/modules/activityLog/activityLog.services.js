...
const getAllActivityLogs = (params, options) => __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, sortBy, sortOrder, skip } = paginationHelpers_1.paginationHelpers.calculatePagination(options);
    const { searchTerm } = params, filterData = __rest(params, ["searchTerm"]);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
            OR: activityLog_constant_1.activityLogSearchableFields.map((field) => ({
    ...
    const total = yield prisma_1.default.activityLog.count({ where: whereConditions });
    return {
...
const getActivityLogById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.activityLog.findUniqueOrThrow({
        where: { id },
        include: {
            user: {
                select: { id: true, name: true, email: true },
